...
@Mod(modid = "totalresurrection", name = "Total Resurrection", version = "0.3.0", dependencies = "required-after:forge@[14.23.5.2768,)", useMetadata = true, acceptedMinecraftVersions = "[1.12.2]", modLanguage = "java", updateJSON = "https://raw.githubusercontent.com/LeyxorCheysen/TotalRessurection/master/versions.json")
